...
class CarousalLayoutManager : LinearLayoutManager {
    private val TAG = "CarousalLayoutManager"
    private val mShrinkAmount = 0.05f
    private val mShrinkDistance = 8.0f
    ...
    override fun scrollVerticallyBy(dy: Int, recycler: Recycler, state: RecyclerView.State): Int {
        ...
        return if (orientation == VERTICAL) {
            ...
            val d0 = 0f
            val d1 = 2.0f * midpoint
            val s0 = 1.05f
            val s1 = 0.12f - mShrinkAmount
